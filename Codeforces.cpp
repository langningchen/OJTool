...
string CODEFORCES::OutputPre(TiXmlElement *Input)
{
    // Output pre tag
    string Output;
    Output += "```\n";
...
string CODEFORCES::Output(TiXmlElement *Input, bool InLatex)
{
    string OutputValue = "";
...
string CODEFORCES::ToNormalName(string Input)
{
...
void CODEFORCES::Login(string Username, string Password)
{
    ...
    if (HTTPResponseCode == 200)
    {
        ...
        if (LoginPageData.find("toNumbers"))
        {
            ...
            system(string("nodejs /tmp/Run.js >> /tmp/Output.tmp").c_str());
